...
5. Seleccione el botón de puntos suspensivos **Definición de la política** (al final del cuadro de texto de la derecha). **Busque** definiciones de directivas que incluyen la **etiqueta** de valor, en el conjunto de resultados, haga clic en la definición **Requerir una etiqueta en los recursos**, luego haga clic en **Seleccionar**.
...
6. En la hoja **Asignar directiva**, en la pestaña **Parámetros**, escriba **Empresa** para el nombre de la etiqueta. Haga clic en **Revisar + crear** y, luego, en **Crear**.

    **Nota:** Este es un ejemplo simple para demostrar el etiquetado. 

    ![Captura de pantalla del panel Asignar política con el nombre de etiqueta completado.](../images/1702.png)
...
6. Haga clic en **Revisar + crear** y verifique que la validación haya sido exitosa. Haga clic en **Crear** para implementar la cuenta de almacenamiento. 
...
2. Tenga en cuenta todas las etiquetas y sus valores. Haga clic en la **Compañía: Contoso** par clave/valor. Esto mostrará una hoja que muestra la cuenta de almacenamiento recién creada, siempre que haya incluido la etiqueta durante su implementación. 
...
4. Haga clic en **Añadir filtro** y añada la clave de etiqueta de la **Compañía** como la categoría de filtro. Con el filtro aplicado, solo se mostrará su cuenta de almacenamiento.

    ![Captura de pantalla del filtro Todos los recursos con la compañía seleccionada.](../images/1706.png)

# Tarea 4 Elimine la asignación de directiva
...
3. Haga clic en **Eliminar asignación** en el panel superior.

4. Confirme que desea eliminar la asignación de directiva en el diálogo **Eliminar asignación** haciendo clic en **Sí**
